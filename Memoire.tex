%TODO : cf NOTES.md ------------------ cf commentaires.md
...
%%% Configuration of how scripts are shown
\usepackage{listings}
\usepackage{color}
...
%% Lien avec AlonePenalty qui pourrait etre deja fait...
%%% COMMENCER ICI !!!!!!!!!!
...
%%% car = investi dans ce groupe deja... = commited
%%% ou si car = salaud (Judas), et ben individualiste : investi dans lui meme ?
%%%% quoique Judas = mieux capture par en bas...........
...
%%%%%%%%%%%% C'est tout ???? ---- already gave up something...
...
\lstinputlisting[language=Python]{Exogenous.py}

\section{Sacrifice.py}
\lstinputlisting[language=Python]{Sacrifice.py}
